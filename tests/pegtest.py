...
class TestGrammars(unittest.TestCase):
    ...
    def test_basic_grammar(self):
        g = PEG.grammar('base', '[1-9]+')
        self.assertEqual(PEG.parse('1234-5678', g), ('-5678', ('base','1234')))
    ...
    def test_oneMore(self):
        g = PEG.grammar("one", '-', PEG.oneMore('[a-z]'), '.', shorted=True)
